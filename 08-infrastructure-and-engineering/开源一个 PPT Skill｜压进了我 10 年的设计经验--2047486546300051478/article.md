...
@op7418 · [X 原文](https://x.com/op7418/article/2047486546300051478)

![封面](assets/001.jpg)

![图片 1](assets/002.jpg)

上周被李继刚老师邀请去做了场私享会关于 AI 和组织的访谈。

散场之后，发现大家问得最多的一句话是:"那个 PPT 是什么做的，能不能开源一下?"

没想到副产品成了主产品。

索性就把它开源了，叫 guizang-ppt-skill（[https://github.com/op7418/guizang-ppt-skill](https://github.com/op7418/guizang-ppt-skill)）。
...
Skill 已经放在 GitHub 上：[github.com/op7418/guizang-ppt-skill](https://github.com/op7418/guizang-ppt-skill)

README 里有一段"给 AI 的安装 prompt"，复制粘贴给你的 Claude Code 或者其他 AI Agent，它会自动完成安装。装好之后对它说一句"帮我做一份杂志风 PPT"就会触发。

也可以在 Bloome 这个 Agent 里面用，目前是**免费**的：

[**https://bloome.im/agent/join/iKXCLtkD?ref=wNL9Ew2G**](https://bloome.im/agent/join/iKXCLtkD?ref=wNL9Ew2G)

**如果觉得内容对你有帮助的话，可以帮我点个赞，或者分享给你需要的朋友。**

也可以在评论区分享一下你拿这个 Skills 做的 PPT。
