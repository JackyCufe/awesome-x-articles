...
@goan999999 · [X 原文](https://x.com/goan999999/article/2095428180878483501)
...
模型可能在两个动作之间来回切换。例如搜索不到答案后，它不断改写关键词，却没有意识到信息本身不存在。没有 \`max\_steps\`，循环会一直消耗时间和费用。
...
- 第一，工具只做一件事。\`search\_and\_write\_and\_send\` 看似省事，一旦中间失败，很难判断哪一步出了问题。
...
我是 G哥，一名 AI 产品经理，我会给大家持续分享真正值得用的 AI 工具、Agent 产品、实战玩法和趋势洞察，帮你用 AI 提效、做产品、找机会、赚到钱。

如果觉得这篇文章能帮到你，先收藏，也欢迎点赞、转发、关注我 [@goan999999](https://x.com/@goan999999)，**一起学 AI，一起把 AI 变成**！
